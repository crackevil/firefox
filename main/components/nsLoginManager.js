...
//@line 113 "c:\builds\moz2_slave\m-rel-w64-00000000000000000000\build\src\toolkit\components\passwordmgr\nsLoginManager.js"
    var contractID = "@mozilla.org/login-manager/storage/json;1";
//@line 115 "c:\builds\moz2_slave\m-rel-w64-00000000000000000000\build\src\toolkit\components\passwordmgr\nsLoginManager.js"
    try {
  ...
  _observer : {
    ...
    observe : function (subject, topic, data) {
      ...
      if (topic == "nsPref:changed") {
        ...
        Task.spawn(function () {
           this._pwmgr._storage.terminate();
          this._pwmgr._initStorage();
           this._pwmgr.initializationPromise;
