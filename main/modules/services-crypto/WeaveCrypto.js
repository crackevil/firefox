...
WeaveCrypto.prototype = {
    ...
    initNSS : function() {
        ...
        var nsslib;
//@line 140 "c:\builds\moz2_slave\m-rel-w64-00000000000000000000\build\src\services\crypto\modules\WeaveCrypto.js"
        let file = Services.dirsvc.get("GreBinD", Ci.nsILocalFile);
        file.append(path);
        this.log("Trying NSS library with path " + file.path);
        nsslib = ctypes.open(file.path);
//@line 145 "c:\builds\moz2_slave\m-rel-w64-00000000000000000000\build\src\services\crypto\modules\WeaveCrypto.js"
